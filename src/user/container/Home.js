        ...
        <>
            ...
            <main id="main">
                    ...
                    <div className="container">
                        <div className="section-title">
                            ...
                            <Title>Nunc aliquam eget nibh eu euismod. Donec dapibus blandit quam volutpat sollicitudin. Fusce tincidunt sit
                                ...
                                suscipit pulvinar. Donec quis tristique lectus.</Title>
                        </div>
                        <div className="row">
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                                <div className="icon-box">
                                    ...
                                    <Title>Nullam accumsan, velit et porta consequat, purus leo congue risus</Title>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                                <div className="icon-box">
                                    ...
                                    <Title>Pellentesque id felis elit. Pellentesque blandit sem a nisi dictum</Title>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                                <div className="icon-box">
                                    ...
                                    <Title>Donec lacinia finibus tortor. Curabitur luctus eleifend odio.</Title>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                                <div className="icon-box">
                                    ...
                                    <Title>Aliquam auctor felis ut sem elementum, ac rutrum turpis venenatis.</Title>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                                <div className="icon-box">
                                    ...
                                    <Title>Etiam in massa eu neque euismod consectetur.</Title>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                                <div className="icon-box">
                                    ...
                                    <Title>Morbi vulputate, tortor nec pellentesque molestie</Title>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="testimonials" className="testimonials">
                    <div className="container">
                        <div className="section-title"><H2 type='H2'>Reviews</H2></div>
                ...
                <section id="gallery" className="gallery">
                    <div className="container">
                        <div className="section-title">
                            <H2 type='H2'>Gallery</H2>
                            <Title>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint
                                consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit
                                in iste officiis commodi quidem hic quas.</Title>
                        </div>
                    </div>
